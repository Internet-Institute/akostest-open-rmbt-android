...
class CoverageResultViewState constructor(
    ...
    var zoom: Float = DefaultLocation.sloveniaZoomLevel
    ...
    override fun onRestoreState(bundle: Bundle?) {
        bundle?.run {
            ...
            cameraPositionLiveData.postValue(LatLng(getDouble(KEY_CAMERA_POSITION_LAT, DefaultLocation.sloveniaLocation.latitude), getDouble(KEY_CAMERA_POSITION_LON, DefaultLocation.sloveniaLocation.longitude)))
        }
    }
